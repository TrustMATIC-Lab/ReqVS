...
parser = argparse.ArgumentParser(description="drugban DTI prediction")
parser.add_argument('--device', type=str, default='cuda')
parser.add_argument('--cfg',  help="path to config file", type=str,default=os.path.join(base_dir, "configs", "drugban.yaml"))
parser.add_argument('--data',  type=str, metavar='TASK',help='dataset',default="chembl36")
parser.add_argument('--split', default='random', type=str, metavar='S', help="split task", choices=['random', 'cold', 'cluster'])
parser.add_argument('--output_dir', type=str, default=os.path.join(base_dir, "weights","result_chembl36"), help='output directory')
...
def main():
    ...
    base_data_folder = os.path.join(base_dir, "datasets")
    dataFolder = os.path.join(base_data_folder, args.data)
